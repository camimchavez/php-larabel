	...
	<div class="container py-4">
		...
		<div class="row">
			...
			<form method="post">
				...
				<input type="text" class="form-control my-2" name="nombreContacto" placeholder="Nombre y apellido" required>

				<input type="email" class="form-control my-2" name="emailContacto" placeholder="Escriba su correo electrónico" required>
