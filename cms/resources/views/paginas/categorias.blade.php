      ...
      <form method="POST" action="{{url('/')}}/categorias" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="input-group mb-3">
            ...
            <input id="" type="text" class="form-control" name="titulo_categoria" value="{{old("titulo_categoria")}}" required placeholder="Ingrese el titulo de la categoría">
          ...
          <form method="POST" action="{{url('/')}}/categorias/{{$value->id_categoria}}" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="input-group mb-3">
                ...
                <input id="" type="text" class="form-control" name="titulo_categoria" value="{{$value->titulo_categoria}}" required placeholder="Ingrese el titulo de la categoría">
