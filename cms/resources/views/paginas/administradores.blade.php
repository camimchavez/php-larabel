              ...
              <table class="table table-bordered table-striped dt-responsive" width="100%" id="tablaAdministradores">
                ...
                <tbody>
                    ...
                    <tr>
                      <td>{{$key+1}}</td>
                       ...
                       if ($value["foto"] == ""){
                        ...
                        echo' <td><img src="'.url('/').'/'.$value["foto"].'" class="img-fluid rounded-circle" alt=""></td>';
                       }
                 ...
                 @endphp
                       <td>
                        <div class="btn-group">
                          <a class="btn btn-warning btn-sm" href="{{url('/')}}/administradores/{{$value["id"]}}">
            ...
            <div class="modal-body">
              ...
              <div class="input-group mb-3">
                ...
                <select class="form-control" name="rol" required>
                  ...
                  @if ($value["rol"] == "administrador" || $value["rol"] == "" || $value["rol"] == NULL)
                ...
                <div class="form-group my-2 text-center">
                  ...
                  @else
                    <img src="{{url('/')}}/{{$value["foto"]}}" class="previsualizarImg img-fluid rounded-circle py-2 w-25">
                 @endif
