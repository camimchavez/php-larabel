        ...
        if(!empty($datos)){
            ...
            if($validar->fails()){
                ...
                if($logo["logo_temporal"] != ""){
                    ...
                    //Esta funcion se puede utilizar para archivos pdf,word,excel,xml. que no se necesite redimensionar
                    //Redimensionar Imágen logo
